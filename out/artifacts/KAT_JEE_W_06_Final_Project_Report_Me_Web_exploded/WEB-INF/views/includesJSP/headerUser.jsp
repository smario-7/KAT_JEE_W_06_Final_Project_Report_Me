    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse d-flex align-content-between" id="navbarSupportedContent">
            ...
            <div class="d-flex justify-content-center">
                <ul class="col nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarMenu" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">
                        Opcje
                    </a>
